...
!      implicit real*8 ::(a-z) 
!      real*8 ::v1(0:NI+1,0:NJ+1,0:NK+1),                       
...
!     &     v4(0:NI+1,0:NJ+1,0:NK+1),v5(0:NI+1,0:NJ+1,0:NK+1)           
      ...
      real*8:: uxi,vyj,hxi,heta,hx,hy,px,py,ujfc 
      real*8:: res,resmax,fiter,fzero 
      real*8:: ainv,be2,fac2,wzsk,wxsk,wysk,Jack,pxi,peta,      &
     &     psig,pgrad,con,pz                                            
                                                                        
      call rpevalgrad(n) 
!      call error('geostroph after rpevalgrad')
