...
!     It is important that u,v,rp have been filled outside the boundarie
      ...
      real*8 ::uint,vint,wint,uxi(0:NI,NJ),uyi(0:NI,NJ),        &
     &     vxj(NI,0:NJ),vyj(NI,0:NJ),rpxi,rpeta,rpsig,fac,fac2,         &
     &     ainv,be2,vcif,vcjf, Jack                                     
      real*8 ::hxi, heta, gradh, hy, py,px 
! the following is not defined in original code, cause problem after changing implicit real to implicit none
      real*8 :: xa, xb, wxsk, wysk, wzsk, kaph1
