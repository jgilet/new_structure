subroutine N2budget(step) 
  ...
  !     zeta*b is vor*b. So zeta*b/(f H) is in (per s^2)                  
      ...
      real*8 ::depth,dz,dzt,dzb,dyinv,dxinv,dzinv,zbt,          &
     &     flocalinv,flocal,bx,by,bz,grav,adv,vol                       
      real*8 ::avezf(NK),avezc(NK),avexyN2(NK),testdepth(3) 
      real*8 ::b(NI,NJ,NK),Dbdt(NI,NJ,NK) 
!     pv is in header and is common                                     
      real*8 ::pv1(NI,NJ,NK),pv2(NI,NJ,NK),pv3(NI,NJ,NK),       &
     &     pvx,pvy,pvz,gravR0,dia,                                      &
     &     gradBxF_top,gradBxF_bot,adv_top,adv_bot,dia_top,dia_bot      
      real*8 ::vor1(NI,NJ,NK),vor2(NI,NJ,NK),vor3(NI,NJ,NK) 
